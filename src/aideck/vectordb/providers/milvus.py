...
from aideck.vectordb.base import BaseVectorDBProvider

from aideck.vectordb.config import (
    Config,
    Mode,
    DistanceMetric,
    IndexType,
...
from aideck.utils.package.exception import(
...
from aideck.schemas.vector_schemas import VectorSearchResult
...
class MilvusProvider(BaseVectorDBProvider):
    ...
    def _get_connection_alias(self) -> str:
        ...
        return f"aideck_milvus_{self._sanitized_collection_name}_{db_name}_{unique_id}"
    ...
    def create_collection(self) -> None:
        ...
        try:
            ...
            schema = CollectionSchema(fields, description=f"Aideck collection: {collection_name}", enable_dynamic_field=True)
