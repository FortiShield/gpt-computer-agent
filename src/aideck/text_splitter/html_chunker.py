...
if TYPE_CHECKING:
    from aideck.text_splitter.base import BaseChunker
...
from aideck.schemas.data_models import Chunk, Document
from aideck.text_splitter.base import BaseChunker, BaseChunkingConfig
from aideck.text_splitter.recursive import RecursiveChunker, RecursiveChunkingConfig
