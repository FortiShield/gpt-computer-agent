...
from aideck.text_splitter.base import BaseChunker, BaseChunkingConfig
from aideck.schemas.data_models import Document, Chunk
from aideck.schemas.agentic import PropositionList, TopicAssignmentList, Topic, RefinedTopic
from aideck.utils.error_wrapper import aideck_error_handler
...
class AgenticChunker(BaseChunker[AgenticChunkingConfig]):
    ...
    @aideck_error_handler(max_retries=1, show_error_details=True)
