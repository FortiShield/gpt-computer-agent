...
class ToolConfig(BaseModel):
    ...
    of a tool within the Aideck framework. This configuration is typically
...
class _ToolDecorator:
    ...
    def __call__(self, func: Callable) -> Callable:
        ...
        """
        setattr(func, '_aideck_tool_config', self.config)
        return func


def tool(*args: Any, **kwargs: Any) -> Callable:
    """
    A decorator to configure the behavior of a tool function within the Aideck framework.
